...
export declare namespace Exec {
  ...
  export type LegacyLiquidityStatusStruct = {
  ...
  export type LegacyLiquidityStatusStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber,
    boolean
  ...
  export type LegacyAssetLiquidityStruct = {
    underlying: string;
    status: Exec.LegacyLiquidityStatusStruct;
  };

  export type LegacyAssetLiquidityStructOutput = [
    string,
    Exec.LegacyLiquidityStatusStructOutput
  ] & { underlying: string; status: Exec.LegacyLiquidityStatusStructOutput };
}
...
export interface ExecInterface extends utils.Interface {
  functions: {
    ...
    "liquidityPerAsset(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "liquidityPerAsset",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface Exec extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[Exec.LegacyAssetLiquidityStructOutput[]]>;
