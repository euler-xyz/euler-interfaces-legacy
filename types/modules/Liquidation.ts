...
export interface LiquidationInterface extends utils.Interface {
  functions: {
    "DISCOUNT_BOOSTER_SLOPE()": FunctionFragment;
    "MAXIMUM_BOOSTER_DISCOUNT()": FunctionFragment;
    "MAXIMUM_DISCOUNT()": FunctionFragment;
    "TARGET_HEALTH()": FunctionFragment;
    "UNDERLYING_RESERVES_FEE()": FunctionFragment;
    "checkLiquidation(address,address,address,address)": FunctionFragment;
    "liquidate(address,address,address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "DISCOUNT_BOOSTER_SLOPE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAXIMUM_BOOSTER_DISCOUNT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAXIMUM_DISCOUNT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "UNDERLYING_RESERVES_FEE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Liquidation extends BaseContract {
  ...
  functions: {
    DISCOUNT_BOOSTER_SLOPE(overrides?: CallOverrides): Promise<[BigNumber]>;

    MAXIMUM_BOOSTER_DISCOUNT(overrides?: CallOverrides): Promise<[BigNumber]>;

    MAXIMUM_DISCOUNT(overrides?: CallOverrides): Promise<[BigNumber]>;

    TARGET_HEALTH(overrides?: CallOverrides): Promise<[BigNumber]>;

    UNDERLYING_RESERVES_FEE(overrides?: CallOverrides): Promise<[BigNumber]>;

    checkLiquidation(
      liquidator: PromiseOrValue<string>,
      violator: PromiseOrValue<string>,
    ...
    liquidate(
      ...
      collateral: PromiseOrValue<string>,
      repay: PromiseOrValue<BigNumberish>,
      minYield: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    ): Promise<Liquidation.LiquidationOpportunityStructOutput>;
  ...
  populateTransaction: {
    ...
    MAXIMUM_DISCOUNT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    TARGET_HEALTH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
